...
public class UserDataDAO extends Activity {
    ...
    public static final String CREATE_TABLE =
            "CREATE TABLE " + TABLE_NAME + " (" +
                    ...
                    ANIMAL_01 + "," + ANIMAL_02 + "," + ANIMAL_03 + "," + ANIMAL_04 + "," +
                    ANIMAL_05 + "," + ANIMAL_06 + "," + ANIMAL_07 + "," + ANIMAL_08 + "," +
                    ANIMAL_09 + "," + ANIMAL_10 + "," + ANIMAL_11 + "," + ANIMAL_12 + "," +
                    ANIMAL_13 + "," + ANIMAL_14 + "," + ANIMAL_15 + "," + ANIMAL_16 + "," +
                    ANIMAL_17 + "," + ANIMAL_18 + "," + ANIMAL_19 + "," + ANIMAL_20 +
                    " )";
